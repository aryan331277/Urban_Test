...
inputs = {}
inputs['Latitude'] = st.number_input("Latitude", min_value=18.9, max_value=28.6, value=19.0760, step=0.0001)
inputs['Longitude'] = st.number_input("Longitude", min_value=72.8, max_value=77.2, value=77.2090, step=0.0001)
